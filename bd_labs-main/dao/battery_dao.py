...
class BatteryDAO:
    ...
    def insert_battery(self, battery):
        ...
        cur.execute(
	    """
	    INSERT INTO battery (station_id, capacity, installation_date, usage_duration) 
	    VALUES (%s, %s, %s, %s)
	    """,
	    ( 
                battery['station_id'],
    ...
    def update_battery(self, battery_id, battery):
	    ...
	    """
	    UPDATE battery 
	    SET station_id = %s, capacity = %s, installation_date = %s, usage_duration = %s 
	    WHERE id = %s
	    """, 
            (
	        battery['station_id'], 
